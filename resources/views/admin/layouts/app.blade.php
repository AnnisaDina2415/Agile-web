...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="w-64 flex-shrink-0 bg-white border-r border-slate-100 flex flex-col transition-all duration-300">
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            <p class="px-3 pt-4 pb-2 text-[10px] font-600 text-slate-400 uppercase tracking-widest" style="font-weight:600">Pengguna & Admin</p>
            ...
            <a href="{{ route('admin.seller-applications.index') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-600 hover:bg-slate-50 transition-colors {{ request()->routeIs('admin.seller-applications*') ? 'active' : '' }}">
                <svg class="w-[18px] h-[18px] text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="px-3 pt-4 pb-2 text-[10px] font-600 text-slate-400 uppercase tracking-widest" style="font-weight:600">Katalog & Transaksi</p>
